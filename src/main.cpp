...
int main() {
    ...
    for (int platformIndex = 0; platformIndex < platformsCount; ++platformIndex) {
        ...
        for (int deviceIndex = 0; deviceIndex < devicesCount; ++deviceIndex) {
            ...
            OCL_SAFE_CALL(clGetDeviceInfo(device, CL_DEVICE_AVAILABLE, sizeof(cl_bool), &deviceAvaliable, nullptr));
            std::cout << "    Device available: " << deviceAvaliable << std::endl;

            cl_bool deviceSupportImage;
            OCL_SAFE_CALL(clGetDeviceInfo(device, CL_DEVICE_IMAGE_SUPPORT, sizeof(cl_bool), &deviceSupportImage, nullptr));
            std::cout << "    Device support image: " << deviceSupportImage << std::endl;
        }
    }
